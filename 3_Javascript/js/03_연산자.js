...
function check() {
  ...
  // -> 다른 연산드리 다 끝나고 마지막에 수행
  // -> console에 출력 후 count 증감 연산 진행

  count = 50;

  console.log(count++); // 50을 출력 후 51 증가
  console.log(count);
  
  console.log(count--); // 51을 출력 후 50 감소
  console.log(count);
...
// 변수명.value : 입력받은 값을 표현하기 위해 필수적으로 사용
// 변수의 위치에 따라 .value의 값이 달라짐 전역변수일 시 일반적으로
// 내가 입력한 값이 공백이기에 정의가 되지 않음
