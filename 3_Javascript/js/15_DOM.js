...
document.querySelector("#btn1").addEventListener("click", () => {
  ...
  // 2. 마지막 자식으로 추가( append("내용", 노드, 요소 * n) )
  list[11].append("12345","abcd", "가나다라");

  // 3. 첫 번째 자식으로 추가( prepend("내용", 노드, 요소 * n) )
  list[11].prepend("오늘", " 점심", " 뭐먹지?");

  // 3. 이전/다음 형제로 추가 ( before/after("내용", 노드, 요소 * n) )
  // #test 전/후에 내용 추가
  test.before("이전 입니다");
  test.after("이후 입니다");
});
...
btn2.addEventListener("click", () => {
  ...
  // #test2 부모 요소
  console.log(test2.parentElement); // <body></body>

  // #test2의 이전형제 요소
  console.log(test2.previousElementSibling); // <pre></pre>

  // #test2의 다음형제 요소
  console.log(test2.nextElementSibling); // <button></button>

  // <li>2번/li> 의 이전 형제 요소
  console.log(test2.children[1].previousElementSibling);
});